...
const LoginCard: React.FC = () => {
    ...
    const handleSubmitLogin = async (e: React.FormEvent) => {
        ...
        params.append('username', login_user.email);
        params.append('password', login_user.password);
        try{
            console.log(params)
        ...
        catch(error:any)
        {
            ...
            if (error.response && error.response.status === 401) {
                ...
                setError("Ocorreu um erro ao tentar fazer o login. Tente novamente mais tarde.");
            }
        }
    };
                ...
                <form onSubmit={handleSubmitLogin} className="space-y-5">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            onChange={(e) =>
                                setLogin({ ...login_user, email: e.target.value })
                            }
                            required
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input 
                                ...
                                onChange={(e) =>
                                    setLogin({ ...login_user, password: e.target.value })
                                }
                                required
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200"
                            />
